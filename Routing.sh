...
then
    gcc -Wall -o ./source/Dijkstra.exe ./source/Dijkstra.c ./source/functions.c -Ofast -lm
fi

if [ ! -f ./source/Astar.exe ]
then
    gcc -Wall -o ./source/Astar.exe ./source/Astar.c ./source/functions.c -Ofast -lm
fi

if [ ! -f ./source/graph_builder.exe ]
then
    gcc -Wall -o ./source/graph_builder.exe ./source/graph_builder.c ./source/functions.c -Ofast -lm
fi
